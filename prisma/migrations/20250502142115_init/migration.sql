/*
  ...
  - Added the required column `slug` to the `Notice` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Notice" ADD COLUMN     "slug" TEXT NOT NULL;
